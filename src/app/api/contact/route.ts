      ...
      html: `
        <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto; padding: 32px; background: #09090b; color: #e4e4e7; border-radius: 16px;">
          ...
          <table style="width: 100%; border-collapse: collapse;">
            <tr><td style="padding: 8px 0; color: #71717a; font-size: 13px; width: 80px;">De</td><td style="padding: 8px 0; color: #e4e4e7;">${name} &lt;${email}&gt;</td></tr>
            <tr><td style="padding: 8px 0; color: #71717a; font-size: 13px;">Asunto</td><td style="padding: 8px 0; color: #e4e4e7;">${subject}</td></tr>
          </table>
          <hr style="border: none; border-top: 1px solid #27272a; margin: 24px 0;" />
          <p style="color: #a1a1aa; font-size: 14px; line-height: 1.7; white-space: pre-wrap;">${message}</p>
          <hr style="border: none; border-top: 1px solid #27272a; margin: 24px 0;" />
          <p style="color: #52525b; font-size: 12px;">Responde directamente a este email para contactar con ${name}.</p>
        </div>
      `,
    });
    ...
    await resend.emails.send({
      ...
      html: `
        <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto; padding: 32px; background: #09090b; color: #e4e4e7; border-radius: 16px;">
          ...
          <h2 style="color: #ffffff; font-size: 24px; font-weight: 900; margin-bottom: 16px;">Gracias, ${name}.</h2>
          <p style="color: #a1a1aa; line-height: 1.7; margin-bottom: 24px;">
            Hemos recibido tu mensaje sobre <strong style="color: #e4e4e7;">"${subject}"</strong>. 
          ...
          <div style="background: #18181b; border: 1px solid #27272a; border-radius: 12px; padding: 20px; margin-bottom: 24px;">
            ...
            <p style="color: #71717a; font-size: 14px; line-height: 1.6; margin: 0; white-space: pre-wrap;">${message}</p>
          </div>
